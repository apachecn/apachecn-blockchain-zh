...
![Cryptographic primitives](img/B05975_03_01.jpg)
...
![Stream ciphers](img/B05975_03_02.jpg)
...
![Block ciphers](img/B05975_03_03.jpg)
...
![Electronic code book](img/B05975_03_04.jpg)
...
![Cipher block chaining](img/B05975_03_05.jpg)
...
![Counter mode](img/B05975_03_06.jpg)
...
![AES steps](img/B05975_03_56.png)
...
![AES steps](img/B05975_03_07.jpg)
...
![An OpenSSL example of how to encrypt and decrypt using AES](img/B05975_03-2.png)
...
![An OpenSSL example of how to encrypt and decrypt using AES](img/B05975_03_40.png)

OpenSSL 支持多种类型的密码；您可以根据前面提供的示例来探索这些选项。下面的屏幕截图显示了支持的密码类型列表:

![An OpenSSL example of how to encrypt and decrypt using AES](img/image_03_008.jpg)
...
![Asymmetric cryptography](img/B05975_03_09.jpg)
...
![Asymmetric cryptography](img/B05975_03_10.jpg)
...
![Elliptic curves](img/image_03_012.jpg)
...
![Mathematics behind ECC](img/image_03_017.jpg)

这里， *A* 和 *B* 与一个称为无穷远点的特殊值一起属于一个有限域 *Zp* 或 *FP* (素数有限域)。无穷远点![Mathematics behind ECC](img/image_03_019.jpg)用于为曲线上的点提供恒等运算。

此外，还需要满足一个条件，以确保前面提到的方程没有重复的根。这意味着曲线是非奇异的。

等式中描述了该条件，这是需要满足的标准要求。更准确地说，这确保了曲线是非奇异的:

![Mathematics behind ECC](img/image_03_020.jpg)

椭圆曲线的实数表示如下图所示。这是实数上的方程图:

![Mathematics behind ECC](img/image_03_012.jpg)

椭圆曲线加密中使用的实际曲线是在有限素数域上，但在这里，它们是在实数上显示的，因为当绘制在 *R* 上时，操作变得更容易可视化:

![Mathematics behind ECC](img/image_03_022.jpg)
...
![Point addition](img/image_03_023.jpg)
...
![Point addition](img/image_03_024.jpg)
...
![Point addition](img/image_03_025-1.jpg)

![Point addition](img/image_03_026.jpg)

这里，结果是这样的:

![Point addition](img/image_03_028.jpg)
...
![Point addition](img/image_03_029.jpg)

使用 Certicom 在线计算器工具增加点数的示例

在示例中，左侧的图表显示了满足此处所示等式的点:

![Point addition](img/image_03_030.jpg)
...
![Point addition](img/image_03_031.jpg)

![Point addition](img/image_03_032.jpg)

![Point addition](img/image_03_033.jpg)

![Point addition](img/image_03_034.jpg)
...
![Point doubling](img/image_03_025-2.jpg)

![Point doubling](img/image_03_026.jpg)

![Point doubling](img/image_03_028.jpg)
...
![Point doubling](img/image_03_030.jpg)

![Point doubling](img/image_03_041.jpg)
...
![Discrete logarithm problem](img/image_03_042.jpg)
...
![Encryption](img/image_03_043.jpg)
...
![Cryptographic primitives](img/B05975_03_18.jpg)
...
![Secure Hash Algorithms (SHAs)](img/B05975_03_19.jpg)
...
*   哈希计算:
    ...
    5.  Finally, the message is processed and the output hash is produced:
        ...
        ![SHA-256](img/B05975_03_20.jpg)

        一轮 SHA 256 压缩功能

在上图中， *a* ， *b* ， *c* ， *d* ， *e* ， *f* ， *g* ， *h* 为寄存器。 **Maj** 和 **Ch** 按位应用。![SHA-256](img/image_03_048.jpg)执行逐位旋转。轮常数为**w<sub class="calibre61">j</sub>t24】和**k<sub class="calibre61">j</sub>t28】，增加了 *mod 2^32* 。****
...
![Design of SHA3 (Keccak)](img/B05975_03_21.jpg)
...
![HMACs (hash-based MACs)](img/B05975_03_22.jpg)
...
![Merkle trees](img/B05975_03_23.jpg)
...
![Distributed hash tables (DHTs)](img/B05975_03_24.jpg)
...
![Digital signatures](img/B05975_03_25.jpg)
...
4.  The signature can be calculated as follows:
    ...
    ![Elliptic Curve Digital signature algorithm (ECDSA)](img/B05975_02-1.jpg)
...
![How to generate a digital signature](img/B05975_03_55.png)
...
![ECDSA using OpenSSL](img/image_03_057.jpg)
